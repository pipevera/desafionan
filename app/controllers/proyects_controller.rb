class ProyectsController < ApplicationController
  ...
  def create
    ...
    people_ids = proyect_params['people_id'].delete_if{|x| x.empty? }
    @people = Person.find(people_ids)
    @proyect.people << @people
  ...
  def delete_person
    ...
    proyect.people.delete(person)

    redirect_to proyects_path, notice: 'person deleted successfully'
  end
  ...
  private
    ...
    def proyect_params
      params.require(:proyect).permit(:name, people_id: [])
    end
end
